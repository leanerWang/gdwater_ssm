...
<div class="main-content" >
    ...
    <div class="wrapper xl-wrapper-height">
        ...
        <div class="col-md-12">
            <div class="white-box">
                <h2 class="header-title">地水位采样点</h2>
                ...
                <form class="" id="param-form" action="${pageContext.request.contextPath}/param/paramCommit"
                      method="post" enctype="multipart/form-data">
                    <div class="row xl-title-margin">
                        <label class="col-md-1">名称</label>
                        <div class="col-md-3">
                            <input type="text" class="xl-form-control" name="name">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <c:forEach var="i" begin="1" end="10">
                        <div class="row m-b-10">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="xl-form-control" name="level">
                            </div>
                            <div class="col-md-2">
